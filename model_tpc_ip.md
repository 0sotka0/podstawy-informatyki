| Nazwa | Warstwy | Opis |
|-------|---------|------|
|Warstwa OSI | Odpawiadająca warstwa TCP\IP | Opis |
|Warstwa 7 - Aplikacji | Warstwa Aplikacj | Interfejs udostępniający programistom usługi dostarczane przez warstwę aplikacji |
| Warstwa 6 - Prezentacji | Warstwa Prezentacji | Warstwa ta odpowiada za kodowanie i konwersję danych oraz za kompresję / dekompresję; szyfrowanie / deszyfrowanie. |
| Warstwa 5 - Sesji | Warstwa Sesji | otrzymuje od różnych aplikacji dane, które muszą zostać odpowiednio zsynchronizowane. |
| Warstwa 4 - Transportowa | Warstwa Transportowa | segmentuje dane oraz składa je w tzw. strumień. |
